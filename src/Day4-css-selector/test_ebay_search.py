...
def test_5():
    ...
    search_box_button = driver.find_element(By.CSS_SELECTOR, ".gh-search-button")
    ...
    print(f"length is {len(list_of_items)}")
    print(f"length is {len(list_of_items_prize)}")
    for i in list_of_items:
        print(i.text)

    for prize in list_of_items_prize:
        print(prize.text)
